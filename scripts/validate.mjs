...
requireMatch('illustrative specimen label', /Decision brief · illustrative/i, html);
requireMatch('legal-advice disclaimer', /not legal advice/i, html);
requireMatch('Open Graph social image', /property="og:image" content="assets\/og\.png"/i, html);
...
requireMatch('scenario interaction', /setupScenario\(\)/, js);
